...
import CardPelamar from "@/component/card/CardPelamar/cardPelamar";
                    ...
                    <div className="bg-white rounded-lg p-2 flex flex-col space-y-2 px-4 mb-4">
                        <div className="flex items-center">
                            <img
                                ...
                                width="50px"
                                src={loker.cover}
                                alt={loker.name_loker}
                            />
                            <div className="flex flex-col mx-4">
                                <h1 className="font-semibold text-sm text-black">{loker.name_loker}</h1>
                                <h2 className="text-xs text-slate-500">{loker.name_perusahaan}</h2>
                            </div>
                        </div>
